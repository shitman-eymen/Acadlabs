...
interface FileUploaderProps {
  onProcessComplete: (result: { text?: string; imageUrl?: string; fileName: string; pdfFile?: File }) => void;
  ...
  const handleFileSubmit = async (file: File) => {
    ...
    try {
      if (fileType === 'image') {
        ...
        // For PDFs, we'll use React-PDF to render them
        await processPDF(file); // Just a placeholder now
        setPdfFile(file);
